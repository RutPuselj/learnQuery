  ...
  describe('array-like properties and methods', () => {
    ...
    describe('map', () => {
      it('should call the callback on each element with the value, index and models array', () => {
        ...
        [0, 1, 2, 3].forEach((index) => {
          ...
          expect(callback.calls.argsFor(index)[0]).toEqual(array[index]);
          expect(callback.calls.argsFor(index)[1]).toEqual(index);
          expect(callback.calls.argsFor(index)[2]).toEqual(array);
        });
      });
    ...
    describe('reduce', () => {
      it('should call the callback on each element with the accumulator, value, index and models array', () => {
        ...
        [0, 1, 2, 3].forEach((index) => {
          expect(callback.calls.argsFor(index)[1]).toEqual(array[index]);
          expect(callback.calls.argsFor(index)[2]).toEqual(index);
          expect(callback.calls.argsFor(index)[3]).toEqual(array);
        });
      });
